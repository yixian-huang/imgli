...
```bash
curl -fsSL https://raw.githubusercontent.com/yixian-huang/imgli/main/scripts/install.sh | sh -s -- v0.10.0
...
Pin a release with `ghcr.io/yixian-huang/imgli:v0.10.0` (see
...
./imgli version     # git tag via ldflags, e.g. v0.10.0
