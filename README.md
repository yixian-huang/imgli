...
```bash
curl -fsSL https://raw.githubusercontent.com/yixian-huang/imgli/main/scripts/install.sh | sh -s -- v0.9.17
...
Pin a release with `ghcr.io/yixian-huang/imgli:v0.9.17` (see
...
./imgli version     # git tag via ldflags, e.g. v0.9.17
